const cards = [
  {
    ...
    link: '/menu/drinks/coffees',
    articles: ['irish', 'esspresso'],
  },
  {
    title: 'Вода',
...

  {
    ...
    link: '/menu/drinks/wines',
  },
  {
    title: 'Жестoки пијалоци',
